...
public class DBApp {
    ...
    public void createTable(String strTableName, String strClusteringKeyColumn, Hashtable<String, String> htblColNameType,Hashtable<String, String> htblColNameMin, Hashtable<String, String> htblColNameMax) throws DBAppException {
        ...
        validation(htblColNameType, htblColNameMin, htblColNameMax); // validation method checks if 
        												//	the type of table's columns is one of the 4 types specified in the description,validation also checks if any column does not have maxVal or minVal , hence throws exception
        ...
        if(!htblColNameType.containsKey(strClusteringKeyColumn))
            throw new DBAppException("The Given Clustering key column does not exist in the table!");
